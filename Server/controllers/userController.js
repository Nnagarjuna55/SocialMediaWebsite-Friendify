...
// //Returns a 404 Not Found if the user does not exist, and a 500 Internal Server Error for other issues.
...
// //Updates the user profile if the user ID matches the logged-in user’s ID.
// //Hashes the password if provided, then updates the user in the database.
// //Returns 403 Forbidden if trying to update another user’s profile.
...
// //Returns 403 Forbidden if trying to delete another user’s profile.
...
// //Updates both users' followers and followings lists accordingly.
// //Returns 400 Bad Request if trying to follow oneself.
...
// //Updates both users' followers and followings lists accordingly.
// //Returns 400 Bad Request if trying to unfollow oneself or if the user is not in the followers list.
