...
// import coverPicture from '../../assets/italy.jpg'; // Import cover picture
// import profilePicture from '../../assets/na.jpeg'; // Import profile picture
...
//                 <img
//                     src={profileDetails.coverPicture ? `${BACKEND_URL}${profileDetails.coverPicture}` : coverPicture}
//                     className="w-full h-72 object-cover"
//                     alt="Cover"
//                 />
//                 <img
//                     src={profileDetails.profilePicture ? `${BACKEND_URL}${profileDetails.profilePicture}` : profilePicture}
...
// import { updateProfile } from '../../redux/authSlice'; // Import the action
...
//         try {
//             const response = await request('/user/updateProfile', 'PUT', {
//                 'Authorization': `Bearer ${token}`,
//                 'Content-Type': 'application/json',
//             }, updatedData);
